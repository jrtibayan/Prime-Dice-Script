 ...
 *          [] roundCount is not increased when you lost the round
 *
 */
...
function recordHitsOnLess990() {
    if(parseFloat(ele.lastRollSpan.innerHTML)<9.90) {
        ...
        currentRound.roundNo = roundCount;
